      ...
      return _react2.default.createElement(
        ...
        function (_ref2) {
          ...
          var stepData = points.map(function (entry, index) {
            ...
            if (prev) {
              var interpolatorCx = (0, _d3Interpolate.interpolateNumber)(prev.cx, entry.cx);
              var interpolatorCy = (0, _d3Interpolate.interpolateNumber)(prev.cy, entry.cy);
              var interpolatorSize = (0, _d3Interpolate.interpolateNumber)(prev.size, entry.size);
            ...
            var interpolator = (0, _d3Interpolate.interpolateNumber)(0, entry.size);
